...
class Session:
    ...
    client_secret: Optional[Any] = None  # Optional client secret for secure sessions
...
class Response:
    ...
    conversation_id: Optional[Any] = None  # ID of the conversation
    modalities: Optional[Any] = None  # Allowed modalities for the response
    voice: Optional[Any] = None  # Allowed voice for the response
    output_audio_format: Optional[Any] = None  # Audio format for the response
